...
setShow(!show)
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
      ...
      <nav className={`fixed -left-44 translate-x-full ${show ? 'block' : 'hidden'} p-4 w-52 border-gray-300 border-r top-20 h-full bg-white`}>
        <button className="text-right text-lg mb-5" onClick={handleClick}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
